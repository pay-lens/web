...
/**
 * This hook makes it easy to fire off a function when the visitor enters the Konami Code on their
 * keyboard (↑ ↑ ↓ ↓ ← → ← → B A). Every web app needs a cheat code right? Read through the code
 * comments below to see how it works. Want to try it out? I'm using this hook in production on
 * divjoy.com. Head over there, enter the code within 5 seconds, and something amazing will happen 😻
 */
