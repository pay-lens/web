 ...
 */
export const createTransitionForProperties = (propertyNames, duration = '0.3s', timingFunction = 'ease', delay = '0s') => {
 ...
 */
export const truncateAtWidth = (width = '100px') => {
 ...
 */
export const boxShadow = (color = colors.black.rgb, offsets = ['0', '2px', '15px', '1px'], opacity = 0.5) =>
 ...
 */
export const linearGradient = (colors, direction = 'to right') => `background: linear-gradient(${direction}, ${colors.join(', ')})`;
